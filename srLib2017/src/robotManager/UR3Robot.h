...
public:
	...
	{
		LINK_1, LINK_2, LINK_3, LINK_4, LINK_5, LINK_6, ENDEFFECTOR, SENSOR, COUPLING, GRIPPER, GRIPPER_FINGER_M, GRIPPER_FINGER_P, GRIPPER_LINK_1_M, GRIPPER_LINK_1_P, GRIPPER_LINK_2_M, GRIPPER_LINK_2_P, OBJECT
	};
	...
	{
		WELDJOINT_SENSOR, WELDJOINT_COUPLING, WELDJOINT_GRIPPER, WELDJOINT_GRIP_MARKER, WELDJOINT_GRIP_OBJECT
	};
