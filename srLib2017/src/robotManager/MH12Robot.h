...
public:
	...
	{
		LINK_1, LINK_2, LINK_3, LINK_4, LINK_5, LINK_6, ENDEFFECTOR, COUPLING, GRIPPER_1, GRIPPER_2, GRIPPER_3, CAMERA
	};
	...
	{
		WELDJOINT_COUPLING, WELDJOINT_GRIPJOINT_1, WELDJOINT_GRIPJOINT_2, WELDJOINT_GRIPJOINT_3, WELDJOINT_GRIP_MARKER, WELDJOINT_CAMERA
	};
