...
void BusBar_HYU::AssembleModel()
{
	...
	m_ObjCollision[0].GetGeomInfo().SetShape(srGeometryInfo::BOX);
	m_ObjCollision[0].GetGeomInfo().SetDimension(Vec3(0.045+0.005, 0.05+0.01, 0.01)); //original size: Vec3(0.045, 0.05, 0.01)
	...
	m_ObjCollision[1].GetGeomInfo().SetDimension(Vec3(0.01+0.005, 0.05+0.01, 0.038)); //original size: Vec3(0.01, 0.05, 0.038)
