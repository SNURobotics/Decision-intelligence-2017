...
MH12RobotManager::MH12RobotManager(MH12Robot * robot, srSpace * space)
{
	...
	gripperJoint[0] = robot->gGripJoint[MH12_Index::GRIPJOINT_1];
	gripperJoint[1] = robot->gGripJoint[MH12_Index::GRIPJOINT_2];
	gripperJoint[2] = robot->gGripJoint[MH12_Index::GRIPJOINT_3];
