...
//	srSpace*  m_Space;
	...
	*/
	...
	void		DIFFKIN_IntegratePosition(double & _step);
	void		(srSystem::*m_pfn_diffkin_integrateposition)(double & _step);
	void		__FS_IntegratePosition_Euler(double & _step);
	void		__L_IntegratePosition_Euler(double & _step);
	...
	void		DYN_ForwardDynamics_Set00(double & _step);
	void		(srSystem::*m_pfn_dyn_forwarddynamics_set00)(double & _step);
	void		_FS_ForwardDynamics_Set00(double & _step);
	void		_L_ForwardDynamics_Set00(double & _step);

	void		__FS_UpdateArticulatedInertia();
	void		__FS_UpdateBiasforce();
	void		__FS_UpdateAcceleration();
	void		__FS_IntegrateVelocity_Euler(double & _step);


	void		__L_UpdateBiasforce();
	void		__L_UpdateAcceleration();
	void		__L_IntegrateVelocity_Euler(double & _step);

	void		DYN_ImpulseDynamics_Set00(double & _fps);
	void		(srSystem::*m_pfn_dyn_impulsedynamics_set00)(double & _fps);
	void		_FS_Impulsedynamics_set00(double & _fps);
	void		_L_Impulsedynamics_set00(double & _fps);

	void		__FS_UpdateBiasImpulse();
	void		__FS_UpdateDelVelocity(double & _fps);
	void		__FS_UpdateVelocity_with_DelVelocity();
	void		__FS_UpdateAcceleration_with_DelVelocity(double & _fps);

	void		__L_UpdateDelVelocity();
	void		__L_UpdateVelocity_with_DelVelocity();
	void		__L_UpdateAcceleration_with_DelVelocity(double & _fps);

	void		DYN_IntegratePosition_Set00(double & _step);
	void		(srSystem::*m_pfn_dyn_integrateposition_set00)(double & _step);
	void		_FS_IntegratePosition_Set00(double & _step);
	void		_L_IntegratePosition_Set00(double & _step);
	...
	void		FS_IntegratePosition_PosErrVel_Euler(double & _step);
	void		FS_IntegratePosition_PosErrVel_plus_Velocity_Euler(double & _step);
