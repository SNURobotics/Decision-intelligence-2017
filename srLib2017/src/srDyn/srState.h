...
public:
	...
	*/
	virtual void UpdateAccWithDelVel(double& fps) = 0;
	/*!
		Force = Force + fps * Impulse
	*/
	virtual void UpdateTorqueWithImp(double& fps) = 0;
	...
	*/
	virtual	void UpdatePosWithPosErrVel(double & timestep) = 0;
	/*!
	...
	*/
	virtual void UpdatePosWithCorrection(double &) = 0;
...
public:
	...
	void UpdateAccWithDelVel(double& ) {};
	void UpdateTorqueWithImp(double& ) {};
	...
	void UpdatePosWithPosErrVel(double &) {};
	void UpdatePosErrVelWithDelVel() {};
	void ResetPosErrVel() {};
	void UpdatePosWithCorrection(double &) {};
