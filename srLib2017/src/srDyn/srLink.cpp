...
double srLink::GetRestitution()
{
	return m_Restitution;
}

double srLink::GetFriction()
{
	return m_Friction;
}

double srLink::GetDamping()
{
	return m_Damping;
}
void srLink::SetRestitution(double v)
{
	if (v >= 0.0)
		m_Restitution = v;
}
void srLink::SetFriction(double v)
{
	if (v >= 0.0)
		m_Friction = v;
}
void srLink::SetDamping(double v)
{
	if (v >= 0.0)
		m_Damping = v;
}
...
void srLink::UpdateInertia(double density)
{
...
void srLink::FS_UpdateImpulse_Link(double & _fps)
{
