...
public:
	...
	*/
	...
	/*!
		...
		Get double value for the first angle of joint when idx equals 0.
		Get double value for the second angle of joint when idx equals 1.
	*/
	double	GetPositionLowerLimit(int idx = 0);
	/*!
		Get upper limit of joint angle.
		Get double value for the first angle of joint when idx equals 0.
		Get double value for the second angle of joint when idx equals 1.
	*/
	double	GetPositionUpperLimit(int idx = 0);
	/*!
		Set limits of joint angle . Upper limit must be greater than lower limit.
		Set double values for the first angle of joint when idx equals 0.
		Set double values for the second angle of joint when idx equals 1.
		Set double values for both angles of joint when idx equals 2.
	*/
	void	SetPositionLimit(double lowerlimit, double upperlimit, int idx = 2);
	/*!
		Get lower limit of joint torque.
		Get double value for the first angle of joint when idx equals 0.
		Get double value for the second angle of joint when idx equals 1.
	*/
	double	GetTorqueLowerLimit(int idx = 0);
	/*!
		Get upper limit of joint torque.
		Get double value for the first angle of joint when idx equals 0.
		Get double value for the second angle of joint when idx equals 1.
	*/
	double	GetTorqueUpperLimit(int idx = 0);
	/*!
		...
		Set double values for both angles of joint when idx equals 2.
	*/
	void	SetTorqueLimit(double lowerlimit, double upperlimit, int idx = 2);
	/*!
		Get offset.
		Get double value for the first angle of joint when idx equals 0.
		Get double value for the second angle of joint when idx equals 1.
	*/
	double	GetOffset(int idx = 0);
	/*!
		Set offset.
		Set double values for the first angle of joint when idx equals 0.
		Set double values for the second angle of joint when idx equals 1.
	*/
	void	SetOffset(double v, int idx = 0);
	/*!
		Get spring coefficient.
		Get double value for the first angle of joint when idx equals 0.
		Get double value for the second angle of joint when idx equals 1.
	*/
	double	GetSpringCoeff(int idx = 0);
	/*!
		...
		Set double values for both angles of joint when idx equals 2.
	*/
	void	SetSpringCoeff(double v, int idx = 2);
	/*!
		Get damping coefficient.
		Get double value for the first angle of joint when idx equals 0.
		Get double value for the second angle of joint when idx equals 1.
	*/
	double	GetDampingCoeff(int idx = 0);
	/*!
		...
		Set double values for both angles of joint when idx equals 2.
	*/
	void	SetDampingCoeff(double v, int idx = 2);
	/*!
...
public:
	...
	*/
	...
	double			 m_FS_K_1, m_FS_K_2;
	AInertia		 m_FS_AI_med;
	double			 m_FS_T1, m_FS_T2;
	se3				 m_FS_W1, m_FS_W2;
