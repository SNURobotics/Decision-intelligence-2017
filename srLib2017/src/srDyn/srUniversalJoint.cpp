...
double srUniversalJoint::GetPositionLowerLimit(int idx /*= 0*/)
{
	if (idx == 0)
...
double srUniversalJoint::GetPositionUpperLimit(int idx /*= 0*/)
{
	if (idx == 0)
...
void srUniversalJoint::SetPositionLimit(double lowerlimit, double upperlimit, int idx /*= 2*/)
{
...
double srUniversalJoint::GetTorqueLowerLimit(int idx /*= 0*/)
{
	if (idx == 0)
...
double srUniversalJoint::GetTorqueUpperLimit(int idx /*= 0*/)
{
	if (idx == 0)
...
void srUniversalJoint::SetTorqueLimit(double lowerlimit, double upperlimit, int idx /*=2*/)
{
	if ( lowerlimit < upperlimit )
	{
		if (idx == 0)
...
double srUniversalJoint::GetOffset(int idx)
{
	if (idx == 0)
		return m_rOffset[0];
	else if (idx == 1)
...
void srUniversalJoint::SetOffset(double v, int idx)
{
	if (idx == 0)
		m_rOffset[0] = v;
	else if (idx == 1)
...
double srUniversalJoint::GetSpringCoeff(int idx)
{
	if (idx == 0)
		return m_rK[0];
	else if (idx == 1)
...
void srUniversalJoint::SetSpringCoeff(double v, int idx)
{
	if (v >= 0.0)
	{
		if (idx == 0)
...
double srUniversalJoint::GetDampingCoeff(int idx)
{
	if (idx == 0)
		return m_rC[0];
	else if (idx == 1)
...
void srUniversalJoint::SetDampingCoeff(double v, int idx)
{
	if (v >= 0.0)
	{
		if (idx == 0)
