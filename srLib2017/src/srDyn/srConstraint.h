...
//#define	INFINITY_BK									1.7976931348623158e+308 // double max value
#define	PINFINITY_BK									1e+300 // double max value
#define	NINFINITY_BK									-1e+300 // double max value

struct ConstraintInfo
{
	double recip_timestep;
...
public:
	...
	virtual void		GetDelVelocity(double * sjari) = 0;
	virtual void		Excite() = 0;
	virtual void		UnExcite() = 0;
	virtual void		SetImpulse(double * _lambda) = 0;
