...
//======= MARK9 =======//
	...
	// Space variables
	double								m_Timestep_fixed;
	double								m_FPS_fixed; // frame per second  ( : 1/timestep )
	...
	void	PRESTEP_MARK9(SystemPtrArray & _systemptrarray, LinkPtrArray & _linkptrarray, JointPtrArray & _jointptrarray, double & _timestep, double & _fps);

	void	_PRESTEP_Set_SpaceVariables___________________MARK9(double & _timestep, double & _fps);
