...
void srLinearSpring::SetK(double k)
{
	if(k >= 0.0)
		m_K = k;
};

void srLinearSpring::SetC(double c)
{
	if(c >= 0.0)
		m_C = c;
};

void srLinearSpring::SetInitialLength(double l)
{
	if(l >= 0.0)
		m_InitialLength = l;
};

double& srLinearSpring::GetLength()
{
...
double& srLinearSpring::UpdateLength()
{
