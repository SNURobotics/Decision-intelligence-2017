...
void Inv3by3_In_BallJoint(double* x, double* b)	// x * b = I
{
...
void MultMV3by3_In_BallJoint(double*a, double*v, double*r)		// a*v=r, a: 3 by 3 matrix, v: 3-dim vector, r:3-dim vector
{
