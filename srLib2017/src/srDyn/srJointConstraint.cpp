...
double JointConstraint::erp_jointpositionlimit = 0.8;
double JointConstraint::allowedjointerror = 0.0001;
double JointConstraint::bouncing_threshold = 0.2;
double JointConstraint::maximum_erp_velocity = 10;
double JointConstraint::maximum_bouncing_velocity = 20;

void JointConstraint::SetErp(double _erp)
{
	erp_jointpositionlimit = _erp;
}

void JointConstraint::SetAllowedPenetration(double _allowedpenetration)
{
	allowedjointerror = _allowedpenetration;
}

void JointConstraint::SetBouncingThreshold(double _bouncingthreshold)
{
	bouncing_threshold = _bouncingthreshold;
}

void JointConstraint::SetMaximumErpVelocity(double _maximum_erp_velocity)
{
	maximum_erp_velocity = _maximum_erp_velocity;
}

void JointConstraint::SetMaximumBouncingVelocity(double _maximum_bouncing_velocity)
{
...
void JointConstraint::_getdelvelocity_R(double * sjari)
{
...
void JointConstraint::_getdelvelocity_P(double * sjari)
{
	if (pSystem->m_bExcited)
...
void JointConstraint::_getdelvelocity_U_1(double * sjari)
{
	if (pSystem->m_bExcited)
...
void JointConstraint::_getdelvelocity_U_2(double * sjari)
{
	if (pSystem->m_bExcited)
...
void JointConstraint::_getdelvelocity_B_Y(double * /* sjari */)
{
	// 미구현
}

void JointConstraint::_getdelvelocity_B_RP(double * /* sjari */)
{
	// 미구현
}

void JointConstraint::GetDelVelocity(double * sjari)
{
...
void JointConstraint::_setimpulse_R(double * _lambda)
{
	m_pRstate->m_rImp += _lambda[0];
}

void JointConstraint::_setimpulse_P(double * _lambda)
{
	m_pPstate->m_rImp += _lambda[0];
}

void JointConstraint::_setimpulse_U_1(double * _lambda)
{
	m_pUstate->m_rImp[0] += _lambda[0];
}

void JointConstraint::_setimpulse_U_2(double * _lambda)
{
	m_pUstate->m_rImp[1] += _lambda[0];
}

void JointConstraint::_setimpulse_B_Y(double * /* _lambda */)
{
	// 미구현
}

void JointConstraint::_setimpulse_B_RP(double * /* _lambda */)
{
	// 미구현
}

void JointConstraint::SetImpulse(double * _lambda)
{
	lambda = _lambda[0];
