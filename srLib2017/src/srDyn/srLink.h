...
public:
	...
	*/
	void		UpdateInertia(double density = 1000.0);
public:
	/*!
		Constructor
	*/
	...
	*/
	...
	/*!
		...
		All the external forces - user external force, 
		force and constraint force(e.g contact force) - are summed up to this value.	*/
	dse3		m_ExtForce;
	/*!
...
public:
	...
	*/
	...
	virtual void		FS_UpdateImpulse_Link(double & _fps);
