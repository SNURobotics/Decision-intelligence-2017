...
public:
	...
	bool			bFriction;
	double			rFriction_coeff;
	bool			bBounce;
	double			rRestitution_coeff;
	...
	/// pre-step
	static	double	_PRESTEP_Calculate_RestitutionCoeff________MARK7(double leftmat, double rightmat);
	static	double	_PRESTEP_Calculate_FrictionCoeff___________MARK7(double leftmat, double rightmat);
	...
	void			HowAboutThisPoint(Vec3& point , Vec3& normal , double& penetration);

	int				FindNearestContactPoint(Vec3 & localpoint_Left); // Left local point 와의 차이를 비교
	void			InsertContactPointAt(Vec3 & point, Vec3 & normal, double & penetration, Vec3& localpoint_Left, int insertIdx);
	int				SortContactPoints(Vec3& localpoint_Left, double & penetration);
	...
	void	GetRelVelocity(double * sjari);
	void	(ContactConstraint::*m_pfn_getrelvelocity)(double * sjari);
	void	_getrelvelocity_LeftMove(double * sjari);
	void	_getrelvelocity_RightMove(double * sjari);
	void	_getrelvelocity_BothMove(double * sjari);
	...
	void	(ContactConstraint::*m_pfn_getdelvelocity)(double * sjari);
	void	_getdelvelocity_LeftMove(double *sjari);
	void	_getdelvelocity_RightMove(double *sjari);
	void	_getdelvelocity_BothMove(double *sjari);
	void	__getdelvelocity_Leftside(double *sjari);
	void	__getdelvelocity_Rightside(double *sjari);
	void	__getdelvelocity_Bothsides(double *sjari);
	void	__getdelvelocity_None(double *sjari);
