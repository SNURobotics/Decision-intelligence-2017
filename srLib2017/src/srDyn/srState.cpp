...
void srRevoluteState::UpdatePosition(double& t)
{
	m_rValue[0] += t * m_rValue[1];
}

void srRevoluteState::UpdateVelocity(double& t)
{
...
void srRevoluteState::UpdateAccWithDelVel(double& fps)	// fps == reciprocal of time step
{
	m_rValue[2] += fps * m_rDelVel;
}

void srRevoluteState::UpdateTorqueWithImp(double& fps)
{
	m_rValue[3] += fps * m_rImp;
}

void srRevoluteState::UpdatePosWithPosErrVel(double& t)
{
...
void srRevoluteState::UpdatePosWithCorrection(double& t)
{
...
void srUniversalState::UpdatePosition(double & t)
{
	m_rValue[0][0] += t * m_rValue[0][1];
	m_rValue[1][0] += t * m_rValue[1][1];
}

void srUniversalState::UpdateVelocity(double & t)
{
...
void srUniversalState::UpdateAccWithDelVel(double & fps)
{
	m_rValue[0][2] += fps * m_rDelVel[0];
	m_rValue[1][2] += fps * m_rDelVel[1];
}

void srUniversalState::UpdateTorqueWithImp(double & fps)
{
	m_rValue[0][3] += fps * m_rImp[0];
	m_rValue[1][3] += fps * m_rImp[1];
}

void srUniversalState::UpdatePosWithPosErrVel(double & t)
{
...
void srUniversalState::UpdatePosWithCorrection(double & t)
{
...
void srBallState::UpdatePosition(double & t)
{
	m_SO3Pos = m_SO3Pos * Exp(t * m_Vel);
}

void srBallState::UpdateVelocity(double & t)
{
	m_Vel += t * m_Acc;
}
...
void srBallState::UpdateAccWithDelVel(double & fps)
{
	m_Acc += fps * m_DelVel;
}

void srBallState::UpdateTorqueWithImp(double & fps)
{
	m_Torque += fps * m_Imp;
}

void srBallState::UpdatePosWithPosErrVel(double & t)
{
...
void srBallState::UpdatePosWithCorrection(double & t)
{
