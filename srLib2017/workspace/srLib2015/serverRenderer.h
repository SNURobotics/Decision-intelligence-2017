...
class serverRenderer : public SceneGraphRenderer
{
	srSpace* targetSpace;
	void (*updatefunc)(void);

public:
	void InitializeNode_1st(srSpace* pSapce)
	{
		targetSpace = pSapce;
		...
		m_camera = new Camera(2.5, 0.2*SR_PI_HALF, 2.0*SR_PI_HALF, focus);
		///////////////////////////////////////////////////////////
