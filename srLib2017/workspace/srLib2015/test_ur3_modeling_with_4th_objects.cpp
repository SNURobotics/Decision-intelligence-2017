...
int main(int argc, char **argv)
{
	...
	// bin location
	bin->setBaseLinkFrame(EulerZYX(Vec3(SR_PI_HALF, 0.0, 0.0), Vec3(0.0, 0.45, 0.0)));
	...
	Eigen::VectorXd goal = rManager1->inverseKin(wayPoints[1], &URRobot->gMarkerLink[UR3_Index::MLINK_GRIP], true, SE3(), flag);
