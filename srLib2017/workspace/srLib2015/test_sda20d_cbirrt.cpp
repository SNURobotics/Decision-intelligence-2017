...
cbirrtManager* RRTManager = new cbirrtManager();
...
int main(int argc, char **argv)
{
	...
	if (doPlanning)
	{
		...
		for (int k = 0; k < 1; k++)
		{
			...
			saveDataToText(traj2, "../../../data/cbirrt_traj/cbirrt_traj_test2.txt");
			...
			saveDataToText(constraintVec2, "../../../data/cbirrt_traj/cbirrt_traj_constraintVec2.txt");
